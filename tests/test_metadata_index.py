...
class TestMetadataIndex(unittest.TestCase):
    ...
    def setUp(self):
        """Set up a fresh vector_index before each test."""
    ...
    def test_add_and_equality_query(self):
        ...
        result = self.index.get_matching_ids({"type": "article", "tags": "vector_index"})
        self.assertEqual({"doc1", "doc3"}, result)
    ...
    def test_update(self):
        """Test updating items in the vector_index."""
        self.index.add(self.item1)
        self.index.add(self.item2)
        ...
        result = self.index.get_matching_ids({"tags": "vector_index"})
        self.assertEqual(set(), result)
    ...
    def test_delete(self):
        """Test deleting items from the vector_index."""
        self.index.add(self.item1)
        self.index.add(self.item2)
        self.index.add(self.item3)
        ...
        # Verify it's removed from equality vector_index
        result = self.index.get_matching_ids({"type": "book"})
        self.assertEqual(set(), result)

        # Verify it's removed from range vector_index
    ...
    def test_serialization(self):
        ...
        # Create a new vector_index and deserialize
    ...
    def test_edge_cases(self):
        ...
        # Non-comparable values for range vector_index
