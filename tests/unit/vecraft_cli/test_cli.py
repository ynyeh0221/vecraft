...
from src.vecraft_cli.vecraft_cli import _run_interactive, _run_direct
# Import the module under test
# Assuming the CLI code is in a file named vecraft_cli.py
from src.vecraft_cli.vecraft_cli import (
    parse_vector,
    get_parser,
    execute_command,
...
class TestExecuteCommand(unittest.TestCase):
    ...
    @patch('src.vecraft_cli.vecraft_cli._handle_list_collections')
    ...
    @patch('src.vecraft_cli.vecraft_cli._handle_insert')
...
class TestMainFunction(unittest.TestCase):
    ...
    @patch('src.vecraft_cli.vecraft_cli._run_direct')
    @patch('src.vecraft_cli.vecraft_cli._has_direct_command_args')
    @patch('src.vecraft_cli.vecraft_cli.get_parser')
    ...
    @patch('src.vecraft_cli.vecraft_cli._run_interactive')
    @patch('src.vecraft_cli.vecraft_cli._has_direct_command_args')
    @patch('src.vecraft_cli.vecraft_cli.get_parser')
...
class TestRunDirect(unittest.TestCase):
    ...
    @patch('src.vecraft_cli.vecraft_cli.VecraftClient')
    @patch('src.vecraft_cli.vecraft_cli.execute_command')
